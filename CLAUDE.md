...
- **Toda pantalla se envuelve en `Page`** (`shared/ui`), que dibuja la banda de encabezado adherida (56 px, con el ícono y el título) **y** el cuerpo con su padding. No recibe descripción: el grupo ya se lee en el menú y en las migas. El padding del cuerpo lo pone `Page` y no cada pantalla, para que ninguna se lo olvide.
